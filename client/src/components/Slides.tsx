export function Slide1() {
  return (
    <div id="slide1" className="slide-container h-screen flex flex-col justify-center items-center text-center grid-background">
      <h1 className="text-7xl font-bold text-white neon-cyan-glow mb-6 font-orbitron">
        AI 時代物流行銷
      </h1>
...
export function Slide2() {
  return (
    <div id="slide2" className="slide-container h-screen flex flex-col justify-center items-center text-center grid-background">
      <hr className="w-24 border-2 border-neon-lime mb-8" />
      <h2 className="text-5xl font-bold mb-4 text-neon-cyan font-orbitron">核心變革思維</h2>
      <p className="text-3xl text-neon-pink font-bold mb-6">物流即行銷，供應鏈即體驗</p>
      <p className="max-w-2xl text-xl text-text-dim leading-relaxed">
...
export function Slide3() {
  return (
    <div id="slide3" className="slide-container min-h-screen flex flex-col justify-center grid-background p-12">
      ...
      <div className="grid grid-cols-2 gap-12 mt-8">
        <div className="bg-neon-cyan/5 border border-neon-pink/20 p-8 rounded">
          ...
          <p className="text-lg text-text-main mb-4">強調硬體資產：車隊數量、倉庫面積。</p>
        ...
        <div className="bg-neon-cyan/5 border border-neon-pink/20 p-8 rounded">
          ...
          <p className="text-lg text-text-main mb-4">強調預測能力：動態履約、黑天鵝免疫。</p>
          <ul className="space-y-3 text-text-main">
...
export function Slide4() {
  return (
    <div id="slide4" className="slide-container min-h-screen flex flex-col justify-center grid-background p-12">
      ...
      <div className="grid grid-cols-3 gap-6 mt-8">
        <div className="bg-neon-cyan/5 border border-neon-cyan/20 p-6 rounded text-center">
          ...
          <p className="text-neon-cyan font-bold mb-2">消費者期待</p>
          <p className="text-text-dim">實時物流追蹤與智能提醒</p>
        </div>
        <div className="bg-neon-cyan/5 border border-neon-cyan/20 p-6 rounded text-center">
          <div className="text-6xl font-bold text-neon-lime mb-4 font-orbitron">3x</div>
          <p className="text-neon-cyan font-bold mb-2">效率提升</p>
          <p className="text-text-dim">AI 調度相比傳統方式</p>
        </div>
        <div className="bg-neon-cyan/5 border border-neon-cyan/20 p-6 rounded text-center">
          <div className="text-6xl font-bold text-neon-lime mb-4 font-orbitron">42%</div>
          <p className="text-neon-cyan font-bold mb-2">成本節省</p>
          <p className="text-text-dim">通過路線優化與預測</p>
        </div>
      </div>
    </div>
  );
...
export function Slide5() {
  return (
    <div id="slide5" className="slide-container min-h-screen flex flex-col justify-center grid-background p-12">
...
export function Slide6() {
  return (
    <div id="slide6" className="slide-container min-h-screen flex flex-col justify-center grid-background p-12">
...
export function Slide7() {
  return (
    <div id="slide7" className="slide-container min-h-screen flex flex-col justify-center grid-background p-12">
      <h2 className="slide-title">深度對比表：維度矩陣</h2>
      <div className="mt-8 overflow-x-auto">
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-opacity-20 bg-neon-pink">
              <th className="border border-neon-cyan/20 px-6 py-4 text-left text-neon-cyan font-orbitron">維度</th>
              <th className="border border-neon-cyan/20 px-6 py-4 text-left text-neon-cyan font-orbitron">傳統物流行銷</th>
              <th className="border border-neon-cyan/20 px-6 py-4 text-left text-neon-cyan font-orbitron">AI 時代物流行銷</th>
            </tr>
          </thead>
          <tbody>
            <tr className="hover:bg-neon-cyan/5">
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main font-bold">核心價值</td>
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main">資產與標準 SLA 競爭</td>
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main">預測精準度與韌性承諾</td>
            </tr>
            <tr className="hover:bg-neon-cyan/5">
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main font-bold">數據角色</td>
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main">後驗式歷史報告</td>
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main">前瞻式需求感測</td>
            </tr>
            <tr className="hover:bg-neon-cyan/5">
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main font-bold">客戶體驗</td>
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main">單向查詢、被動告知</td>
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main">AI Agent 智能共感、主動預警</td>
            </tr>
            <tr className="hover:bg-neon-cyan/5">
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main font-bold">ESG 敘事</td>
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main">表面綠化 (Greenwashing)</td>
              <td className="border border-neon-cyan/20 px-6 py-4 text-text-main">數據化綠色競爭力 (範疇三)</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export function Slide8() {
  return (
    <div id="slide8" className="slide-container min-h-screen flex flex-col justify-center grid-background p-12">
...
export function Slide9() {
  return (
    <div id="slide9" className="slide-container min-h-screen grid grid-cols-2 grid-background overflow-hidden">
...
export function Slide10() {
  return (
    <div id="slide10" className="slide-container min-h-screen flex flex-col justify-center grid-background p-12">
        ...
        <div className="bg-black/40 p-8 rounded border border-neon-lime">
          <ul className="space-y-6">
            <li className="flex items-start">
              ...
              <div>
                <strong className="text-text-main">演算法優化：</strong>
                <p className="text-text-dim mt-1">透過 AI 即時計算最優低碳路徑，減少無效里程。</p>
              </div>
            </li>
            <li className="flex items-start">
              <i className="fas fa-chart-line text-neon-lime mr-4 mt-1 text-xl"></i>
              <div>
                <strong className="text-text-main">範疇三數據：</strong>
                <p className="text-text-dim mt-1">提供清晰、可驗證的減碳儀表板，助品牌主滿足綠色法規。</p>
              </div>
            </li>
            <li className="flex items-start">
              <i className="fas fa-shield-halved text-neon-lime mr-4 mt-1 text-xl"></i>
              <div>
                <strong className="text-text-main">法律效益：</strong>
                <p className="text-text-dim mt-1">將綠色物流從「口號」轉變為具備法律效益的數據支持。</p>
              </div>
            </li>
          </ul>
        </div>
...
export function RecommendedVideos() {
  ...
  return (
    <div id="recommended-videos" className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-950 to-black p-12 flex flex-col justify-center">
      <div className="max-w-5xl mx-auto w-full">
        {/* Header */}
        <div className="mb-12 text-center">
          <p className="text-xs font-bold text-neon-lime uppercase tracking-widest mb-4">推薦影片</p>
          <h2 className="text-5xl font-bold text-neon-cyan font-orbitron mb-4">相關視頻資源</h2>
            ...
            >
              <div className="flex gap-4 p-4">
                ...
                <div className="flex-1 flex flex-col justify-center">
                  <h3 className="text-lg font-bold text-neon-cyan group-hover:text-neon-lime transition-colors mb-2">
                    {video.title}
                  </h3>
